...
`@Deprecated()` decorator + `DeprecationInterceptor` for REST route lifecycle per ADR 0033.
...
Sunset windows per ADR 0033: public APIs 6 months minimum, internal-only 2 months minimum.
