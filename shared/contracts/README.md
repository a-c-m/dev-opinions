...
See [ADR 0019](../../docs/adr/0019-api-contracts-and-errors.md) for the full composition pattern and [ADR 0011](../../docs/adr/0011-drizzle-orm.md) for the vocabulary-tuple convention shared schemas use.
