...
# ADR 0018: Safe database migrations
...
handling and aren't covered by [ADR 0011](0011-drizzle-orm.md)
...
- Target table is "large by your fork's standards" — your
  sanitised stage clone ([ADR 0036](0036-production-data-flow.md))
...
([ADR 0032](0032-github-actions-ci.md)) so the SQL execution
...
With >1 replica per [ADR 0034](0034-container-conventions.md),
...
[ADR 0026](0026-secrets-runtime-injection.md).
...
[ADR 0019](0019-api-contracts-and-errors.md)'s versioning
...
[ADR 0011](0011-drizzle-orm.md). Each package's `package.json`
...
- **SQLite migration nuance** — [ADR 0011](0011-drizzle-orm.md)
...
- **Builds on [0011](0011-drizzle-orm.md)** — schemas + per-package
  migration histories
...
- **Consumed by [0035](0035-branching-releases-environments.md)**
  — `deploy-prod.yml` runs migrations before pod promotion
- **References [0036](0036-production-data-flow.md)** — sanitised
  stage clones are the only honest dry-run target
- **Companion runbook**: [`docs/runbooks/supervised-db-migrations.md`](../runbooks/supervised-db-migrations.md)
  (format conventions in [`docs/runbooks/AGENTS.md`](../runbooks/AGENTS.md))
