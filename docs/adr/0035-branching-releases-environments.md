...
# ADR 0035: Branching, releases, and environments
...
and [SemVer](https://semver.org/). [ADR 0036](0036-production-data-flow.md) covers the data direction (production → lower envs).
...
(Conventional Commits — [ADR 0031](0031-github-repo-conventions.md)).
...
4. **Tag.** Workflow (`tag-release.yml`) bumps version, commits on
   ...
   from conventional commits ([ADR 0031](0031-github-repo-conventions.md)).
...
- **`main` and `release-candidate`**: PR required, ≥1 approval,
  CODEOWNERS review ([ADR 0031](0031-github-repo-conventions.md)),
  required status checks ([ADR 0032](0032-github-actions-ci.md)),
...
- **[ADR 0031](0031-github-repo-conventions.md)** — Conventional Commits that drive auto-bump + CODEOWNERS review.
- **[ADR 0032](0032-github-actions-ci.md)** — workflow shape this builds on.
- **[ADR 0036](0036-production-data-flow.md)** — companion (production data flow).
- **[ADR 0005](0005-child-apps-and-repos.md)** — recommended (not enforced) for children.
