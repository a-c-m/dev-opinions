...
Selection is config-driven per [ADR 0016](0016-backend-config.md):
...
([ADR 0011](0011-drizzle-orm.md)) and the indexed session
...
to change plan" pain. Aligns with [ADR 0029](0029-feature-flags.md)'s
