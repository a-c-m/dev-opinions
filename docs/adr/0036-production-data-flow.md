...
# ADR 0036: Production data flow to lower environments

## Context and Problem Statement

[ADR 0035](0035-branching-releases-environments.md) covers code
...
- **hosted dev** (when present, per [ADR 0035](0035-branching-releases-environments.md)):
  a **1% cutdown of stage** — same shape, smaller volume.
- **developer laptops**: pull the artifact directly, IAM-gated.
- **temp env** ([ADR 0035](0035-branching-releases-environments.md)):
...
- [`docs/runbooks/AGENTS.md`](../runbooks/AGENTS.md) — per-service
  sanitisation and restore may carry their own runbooks; format conventions live there.
