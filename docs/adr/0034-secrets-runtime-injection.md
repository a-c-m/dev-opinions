...
# ADR 0034: Secrets injection at runtime

## Context and Problem Statement

[ADR 0015](0015-backend-config.md) settles the *shape* of
...
Stacks with [ADR 0032](0032-runtime-observability.md)'s OTel
boot order:

```dockerfile
# updates ADR 0023 runtime stage
...
[ADR 0015](0015-backend-config.md)'s dev workflow updates:
...
- **1Password (`op run --`)** is the named default. Carries
  forward from ADR 0015's "fill from 1Password" dev story.
...
[ADR 0021](0021-github-actions-ci.md) already prescribes
